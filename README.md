...
ci-cd.yml настроен так, что при выполнии коммита внутри репозитория с тестовым приложением (например, коммит Update ci-cd.yml в ветку main), происходит новая сборка и оправка его в наш Dockerhub без деплоя в кластер:     

...
На этом этапе Terraform конфигурации были адаптированы под работу с Terraform Cloud, git репозиторий подключен к 2 Workplaces c названиями, идентичными с таковыми в git репозитории:

![](./img/4.1.png)       
![](./img/4.2.png)       
![](./img/4.3.png)       

Оба Workplaces отработали успешно, в выводе - ID созданного кластера, в yandex cloud - он же:     

...
Интерфейс grafana доступен по публичному ip-адресу [](http://84.252.135.57) (login: admin, password: prom-operator), видны те же ноды, что и создались сейчас вместе с кластером:    

![](./img/4.8.png)       
![](./img/4.9.png)       
![](./img/4.10.png)       

А вот наше приложение, доступное по тому же публичному ip-адресу с префиксом пути `/app` [](http://84.252.135.57/app):     
